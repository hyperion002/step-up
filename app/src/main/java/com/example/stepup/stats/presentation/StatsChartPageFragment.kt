...
import com.example.stepup.databinding.FragmentStatsChartPageBinding
import com.example.stepup.stats.util.toChartValues
...
class StatsChartPageFragment : Fragment() {
    ...
    private var _binding: FragmentStatsChartPageBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentStatsChartPageBinding.inflate(inflater, container, false)
        return binding.root
    }
